...
SEXP  NCEAcov(SEXP mm2, SEXP mm3, SEXP mm4, SEXP mm11, SEXP PP, SEXP NN, SEXP XXc, 
              SEXP iincludem2, SEXP iincludem3, SEXP iincludem4) {
  
  /*
   arguments
   mm2       : numeric vector with unique covariance elements
   mm3       : numeric vector with unique coskewness elements
   mm4       : numeric vector with unique cokurtosis elements
